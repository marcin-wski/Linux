...
dnf install wget tmux htop net-tools sysstat openssh-server nmap vlc java-openjdk icedtea-web gimp youtube-dl unzip bridge-utils libvirt virt-install qemu-kvm virt-top libguestfs-tools virt-manager virsh transmission discord libreoffice libreoffice-langpack-en libreoffice-langpack-pl aisleriot steam -y
